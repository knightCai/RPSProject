...
public class  GlobalParam {
	 ...
	 * =================================打印参数========================================
	 */
	public static String PRINT_CONSIGNERNAME = "";//" 速度";	//寄件人名称
	...
	public static String PRINT_CARGONAME_CARGOTYPE = "";//"手动阀手动阀手动阀手动阀撒";//"品名+品牌+数量+规格型号\r\n品名+品牌+数量+规格型号\r\n品名+品牌+数量+规格型号\r\n品名+品牌+数量+规格型号\r\n品名+品牌+数量+规格型号\r\n";	//货物内容描述：品名+品牌+数量+规格型号
	...
	public static String SOURCE_IMPORTTEMPLEDIY = "/source/importTempleDIY.xls";		//导入模板文件的存放路径YTO模板
