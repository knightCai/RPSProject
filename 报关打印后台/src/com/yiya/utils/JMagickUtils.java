...
//	private final static String YIYA_LOGO_LOGO = "d:\\t2\\watermark_logo.png";
	private final static String YIYA_LOGO_BG = PathUtil.getRootPath()+"/static/common/images/watermark_bg.png" ; //水印背景图片 白色半透明
	private final static String YIYA_LOGO_LOGO = PathUtil.getRootPath()+"/static/common/images/watermark_logo.png" ;//水印图片 名称+网址
