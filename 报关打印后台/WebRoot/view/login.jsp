							...
							<div class=user_main_box>
								<ul>
									...
									<li class=user_main_input>
										<input class="txtusernamecssclass easyui-validatebox"  data-options="required:true,validType:'text',missingMessage:'账号不能为空.'" name="email"  value="kfadmin" maxlength="20">
									</li>
								</ul>
								<ul>
									<li class=user_main_text>
									...
									<li class=user_main_input>
										<input class="txtpasswordcssclass easyui-validatebox"   data-options="required:true,missingMessage:'密码不能为空.'" type="password" name="pwd" value="123123">
									</li>
								</ul>
								<!--	屏蔽验证码 
									<ul>
