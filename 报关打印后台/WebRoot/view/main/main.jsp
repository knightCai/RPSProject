...
<html>
  ...
  <body class="easyui-layout">
	...
	<!-- 树形菜单 -->
	<div data-options="region:'west',split:true,title:'隐藏'" style="width:200px;">
	...
	<div data-options="region:'south',split:true,border:false" style="height: 30px;overflow:hidden;">
		<div class="panel-header" style="border: none;text-align: center;" >CopyRight &copy; 2017 KnightCai 版权所有.</div>
	</div>
	<!-- 中间内容页面 -->
		...
		<div class="easyui-tabs" id="tab-box" data-options="fit:true,border:false">
			<div title="Welcome" style="padding:20px;overflow:hidden;"> 
				<div style="margin-top:20px;">
					<h3>欢迎访问报单打印-后台管理系统</h3>
					<ul>
						<li>本系统为“报单打印系统”后台管理系统。</li> 
					</ul>
				</div>
	...
	<div id="modify-pwd-win"  class="easyui-dialog" buttons="#editPwdbtn" title="修改用户密码" data-options="closed:true,iconCls:'icon-save',modal:true" style="width:350px;height:200px;">
		<form id="pwdForm" action="modifyPwd.do" class="ui-form" method="post">
     		 ...
     		 <div class="ui-edit">
	           <div class="fitem">  
	              <label>旧密码:</label>  
	              <input id="oldPwd" name="oldPwd" type="password" class="easyui-validatebox"  missingMessage="该项不能为空" data-options="required:true"/>
	           </div>
	            <div class="fitem">  
	               <label>新密码:</label>  
	               <input id="newPwd" name="newPwd" type="password" class="easyui-validatebox" missingMessage="该项不能为空" data-options="required:true" />
	           </div> 
	           <div class="fitem">  
	               <label>重复密码:</label>  
	              <input id="rpwd" name="rpwd" type="password" class="easyui-validatebox"   required="required" missingMessage="该项不能为空" validType="equals['#newPwd']" />
	           </div> 
	         </div>
     	 </form>
